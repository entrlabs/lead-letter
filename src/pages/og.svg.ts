...
<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="630" viewBox="0 0 1200 630">
  ...
  <g transform="translate(112 116)">
    <rect x="-12" y="-16" width="78" height="86" rx="20" fill="#2E5BD0" opacity=".96"/>
    <text x="27" y="40" text-anchor="middle" font-family="Archivo, Arial, sans-serif" font-size="20" font-weight="800" fill="#FFFFFF">E</text>
